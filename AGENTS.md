...
- **当前状态以探针为准**：先运行 `python3 scripts/local_scheduler_status.py --json`、`python3 scripts/check_orphan_workers.py --json`；叙述性快照若与探针冲突，先修正文档再推进。2026-06-12 Block #21 后的 Phase A 安全入口是 `D-MR-108`（524–526 章）。
